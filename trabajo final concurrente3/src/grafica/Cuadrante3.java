...
public class Cuadrante3 extends Cuadrante {

     JugadorL cuad3=null;

    public Cuadrante3(int x, int y, List<Grafico> todos) {
        this.x = x;
        this.y = y;
        this.w = 25;
        this.h = 25;
    ...
    public Boolean colisionoCon(JugadorL gr) {
        ...
        System.out.println("Colision de cuadrante3 con Jugador");
        ...
        if (cuad3!=null)
        {
            ...
            if(cuad3.r.intersects(rectChico)==false)
                cuad3=null;
        }
